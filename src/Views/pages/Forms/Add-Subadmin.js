...
import { postAdminAsync } from '../../../store/features/PostAdminSlice'
...
const handleChange =(e)=>{
  ...
  }else{setAddAdmin({...addAdmin,[name]:value})}
  ...
  useEffect(()=>{
    if(Object.keys(err).length===0 && userData)
    dispatch(postAdminAsync(addAdmin))
  },[err,userData])
