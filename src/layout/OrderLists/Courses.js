...
import images1 from '../../assets/images/orderwith-us/article-1.png'
    ...
    <div className="books-outer-wrap-course main-container bg-wrap">
      <>
        <div className="inner-news-wrap">
          <Container>
            <h2 className="fw-bold py-5">Courses</h2>
            <Row>
              {data?.map((item, index) => {
                return (
                  <Col key={index} md="6" lg="4" xl="4" xxl="4">
                    <div className="p-4 inner-newletter-card">
                      <img className="img-fluid mt-3 main-wrap-img" src={images1} alt="courseimg" />
